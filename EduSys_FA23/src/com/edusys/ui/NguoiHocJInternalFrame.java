...
public class NguoiHocJInternalFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnTimKiem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/ui/icon/Search.png"))); // NOI18N
...
//        this.updateStatus();
    ...
    private void fillTable() {
        ...
        try {
            ...
            for (NguoiHoc nh : list) {
                model.addRow(new Object[]{nh.getMaNH(), nh.getHoTen(), nh.isGioiTinh() ? "Nam" : "Nữ", nh.getNgaySinh(), nh.getDienThoai(),
    ...
    private void fillTimKiem() {
        ...
        try {
            ...
            this.list = this.dao.selectByKeyword(hoTen);
            for (NguoiHoc nh : list) {
                model.addRow(new Object[]{nh.getMaNH(), nh.getHoTen(), nh.isGioiTinh() ? "Nam" : "Nữ", nh.getNgaySinh(), nh.getDienThoai(),
                    nh.getEmail(), nh.getMaNV(), nh.getNgayDK()});
            }
    ...
    private void setForm(NguoiHoc nh) {
        ...
        jdcNgaySinh.setDate(nh.getNgaySinh());
    ...
    private NguoiHoc getForm() {
        ...
        nh.setNgaySinh(jdcNgaySinh.getDate());
